...
// #include "devices/I2CSensor.h"
// #include "devices/RotaryEncoderSwitch.h"
...
void setup()
{
    ...
    if (co2.enableAutomaticSelfCalibration() == true)
    {
...
void loop()
{
    ...
    static float test = 0; // Variable to store CO2 data

    // Get CO2 data
    if (co2.measureGasConcentration())
    {
        co2data = co2.getCO2();
        test = co2.getTemperature();
        delay(100);        
    }
